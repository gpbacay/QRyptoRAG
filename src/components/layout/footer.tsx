        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 col-span-3 gap-8 text-sm">
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="https://github.com/firebase/genkit" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary transition-colors flex items-center gap-2"><Github className="w-4 h-4"/> GitHub</a></li>
            ...
            <div>
              ...
              <ul className="space-y-2">
                ...
                <li>
                  <a href="https://www.npmjs.com/package/qryptography" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-primary transition-colors flex items-center gap-2">
